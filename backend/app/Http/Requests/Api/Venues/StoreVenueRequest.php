...
class StoreVenueRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique(Venue::class, 'slug')],
            'description' => ['nullable', 'string'],
            'venue_type' => ['required', Rule::in([Venue::TYPE_RESTAURANT, Venue::TYPE_BAR, Venue::TYPE_LOUNGE, Venue::TYPE_CAFE])],
