...
@extends('emails.layouts.tiketa', [
    ...
    'preheader' => __('emails.cancelled_copy', ['venue' => $venue->name]),
    'eyebrow' => __('emails.brand_reservations'),
    'heading' => __('emails.reservation_cancelled'),
    'intro' => __('emails.cancelled_copy', ['venue' => $venue->name]),
])
...
@section('content')
    ...
    @include('emails.components.message-box', [
        'type' => 'warning',
        'title' => __('emails.reservation_cancelled'),
        'body' => e(__('emails.thank_you')).'<div style="margin-top:16px;">'.view('emails.components.button', ['url' => $reservationUrl, 'label' => __('emails.view_reservation'), 'variant' => 'secondary'])->render().'</div>',
    ])
    ...
    @include('emails.components.details', [
        'items' => [
            ...
            ['label' => __('emails.reason'), 'value' => e($reservation->owner_cancellation_reason ?: ($reservation->cancellation_reason ?: __('emails.no_reason_provided')))],
        ],
    ])
@endsection
