...
<head>
    ...
    <title>Verify your Tiketa email</title>
</head>
                ...
                <table role="presentation" width="620" cellspacing="0" cellpadding="0" style="width:620px;max-width:100%;background:#ffffff;border:1px solid #dbe3ef;border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">Welcome to Tiketa, {{ $user->name ?: 'there' }}.</p>
                            ...
                            <p style="margin:22px 0 0;color:#64748b;font-size:13px;line-height:1.5;">This verification link expires in {{ $expirationMinutes }} minutes. If you did not create an Tiketa account, you can ignore this email.</p>
