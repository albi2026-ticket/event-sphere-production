...
<head>
    ...
    <title>Reset your Tiketa password</title>
</head>
                ...
                <table role="presentation" width="620" cellspacing="0" cellpadding="0" style="width:620px;max-width:100%;background:#ffffff;border:1px solid #dbe3ef;border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 22px;color:#475569;line-height:1.6;">We received a request to reset your Tiketa password. Use the button below to choose a new password.</p>
                            ...
                            <p style="margin:24px 0 0;color:#475569;line-height:1.5;">Tiketa Team</p>
                        </td>
                    </tr>
                </table>
            </td>
